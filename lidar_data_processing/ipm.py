...
def update_perspective(val):
    ...
    destination = cv2.warpPerspective(frame, transformationMat, 
                    image_size, flags=cv2.INTER_CUBIC + cv2.WARP_INVERSE_MAP)
...
cv2.createTrackbar("Focal", "Result", 500, 2000, update_perspective)
cv2.createTrackbar("Dist",  "Result", 500, 2000, update_perspective)
